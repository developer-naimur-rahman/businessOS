  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 py-12 md:py-20 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div>
          <h1 className="text-4xl font-semibold tracking-tight text-slate-900 mb-3">All Products</h1>
          <p className="text-lg text-slate-500 max-w-xl">
            Browse our complete catalog of premium technology and office essentials.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-32 bg-slate-50 rounded-3xl border border-slate-100">
          ...
          <p className="text-slate-500">We couldn't find any active products in the catalog.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
